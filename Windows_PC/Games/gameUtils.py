...
class Board:
	...
	def draw_board(self):
		...
		pygame.draw.line(self.DISPLAYSURF, WHITE, (self.x_margin, self.y_margin), (self.x_margin + BOARD_WIDTH, self.y_margin))
		# Draw low board line
		pygame.draw.line(self.DISPLAYSURF, WHITE, (self.x_margin, self.y_margin + BOARD_HEIGHT), (self.x_margin + BOARD_WIDTH, self.y_margin + BOARD_HEIGHT))
		# Draw left board line
		pygame.draw.line(self.DISPLAYSURF, WHITE, (self.x_margin, self.y_margin), (self.x_margin, self.y_margin + BOARD_HEIGHT))
		# Draw right board line
		pygame.draw.line(self.DISPLAYSURF, WHITE, (self.x_margin + BOARD_WIDTH, self.y_margin), (self.x_margin + BOARD_WIDTH, self.y_margin + BOARD_HEIGHT))
		# Draw players' drones
